...
/**
 * Aguarda um pequeno delay artificial, **somente em ambientes de desenvolvimento ou testes**.
 *
 ...
 *
 * @example-- await devOnlyDelay(500); // só espera se estiver em 'e2e', 'test' ou 'development'
 */
